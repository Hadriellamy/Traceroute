defmodule TracerouteMonitor.CategoriesTest do
  use TracerouteMonitor.DataCase

  alias TracerouteMonitor.Categories

  describe "categories" do
    alias TracerouteMonitor.Categories.Category

    import TracerouteMonitor.CategoriesFixtures
